...
@Entity
@Table(name = "family_status", schema = "csr")
public final class CSRFamilyStatusEntity {
    /**
  ...
  generator = "family_status_seq")
    @SequenceGenerator(
        name = "family_status_seq",
        sequenceName = "csr.family_status_id_seq",
        allocationSize = 1
    )
    private Long                    id;
    /** Creates a new instance of {@link CSRFamilyStatusEntity}. */
    public CSRFamilyStatusEntity() {
        super();
    }
    /**
     * Gets the id.
