...
@Entity
@Table(name = "sibling_rank", schema = "csr")
public final class CSRSiblingRankEntity {
    /**
     * the primary key - an autogenerated id (unique for each user in the db).
     */
    @Id
    @Column(name = "sibling_rank_id")
    @GeneratedValue(strategy = GenerationType.SEQUENCE,
  generator = "sibling_rank_seq")
    @SequenceGenerator(
        name = "sibling_rank_seq",
        sequenceName = "csr.sibling_rank_id_seq",
        allocationSize = 1
    )
    private Long                    id;
    /** Creates a new instance of {@link CSRSiblingRankEntity}. */
    public CSRSiblingRankEntity() {
        super();
    }
    /**
     * Gets the id.
